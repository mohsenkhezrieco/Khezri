function out = matadd(x,y) 
% PURPOSE: performs matrix addition even if matrices 
%          are not of the same dimension, but are row or 
%          column compatible 
%--------------------------------------------------- 
% USAGE: result = matadd(x,y) 
...
elseif (rx == ry) & (cy == 1); 
   ...
   error('matadd: non-conformable in row or column dimension') 
end 
